...
import chairIcon from "../../../assets/HomePage/Stockholm-icons-Chair.svg";
...
const BreakfastList = ({ setBookTypeModal, setSelectedRestaurant }) => {
  const {
    data: restaurantLists,
    noData: empty,
    isLoading,
    error,
  } = useFetch(URL + "restaurant/tag/breakfast ");
      ...
      <Container span={24}>
        <Row justify="space-between" align="middle">
          ...
          <Col span={24}>
            {restaurantLists && (
              <Row justify="space-between" align="middle">
                {restaurantLists.restaurants.result.map((restaurant) => (
                  <CardContainer
                    span={7}
                    key={restaurant._id}
                    onClick={() =>
                      ...
                      <Col span={23}>
                        <Row justify="space-between" align="middle">
                          <Table span={10}>
                            <Row justify="center" align="middle">
                              <Col span={5}>
                                <Image src={chairIcon} preview={false} />{" "}
                              </Col>
                              <Col span={16}>
